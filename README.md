...
# log4j-samples
Samples of log4j library versions to help log4j scanners / detectors improve their accuracy.
...
Notice our latest scan has one mistake:  "log4j-over-slf4j-1.7.32.jar" is not actually Log4J-1.x.
